...
class AlgorithmSelect:
    def __init__(self, window, selected_grid=None, grid_mode='random'):
        self.window = window
    ...
    def start_visualizer(self, algorithm):
        self.window.change_page(Visualizer, self.selected_grid, self.grid_mode, algorithm)
    ...
    def draw(self, screen):
        ...
        sub = font2.render(f"Grid: {self.selected_grid} ({'Fixed' if self.grid_mode=='fixed' else 'Random'})", True, (200, 200, 200))
